...
export default () => {
  return (
    ...
    >
      <Panel header="Word Segmentation (WS)" key="1">
        <p>
          WS is the word tokenization of thai words with the HMM model and Viterbi algorithm for
          computing possibilities of possible words with their POS tags. The input of this model is
          words. The output is the tokenized words with their POS tags.
        </p>
